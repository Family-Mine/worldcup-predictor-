    ...
    <div className="bg-surface-card border border-surface-border rounded-2xl p-8 text-center">
      ...
      <div className="flex items-center justify-center gap-6 md:gap-12">
        <div className="flex flex-col items-center gap-3 flex-1">
          <TeamFlag countryCode={match.home_team?.country_code ?? ''} name={match.home_team?.name ?? 'TBD'} size="xl" />
          <span className="text-lg md:text-xl font-bold text-white text-center">{match.home_team?.name ?? 'TBD'}</span>
        ...
        <div className="flex flex-col items-center gap-3 flex-1">
          <TeamFlag countryCode={match.away_team?.country_code ?? ''} name={match.away_team?.name ?? 'TBD'} size="xl" />
          <span className="text-lg md:text-xl font-bold text-white text-center">{match.away_team?.name ?? 'TBD'}</span>
